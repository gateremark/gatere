	...
	return (
		<>
			<div className="flex justify-around gap-4 md:gap-10">
				...
				<a
					className="inline-block text-sm md:text-lg text-[#fff] bg-[#690cc6] px-2 py-3 md:py-3 md:px-5 br border-[#690cc6] border-b-[3px] rounded-md hover:bg-[#380d63] transition ease-in-out duration-500 "
					href="#Contact"
				>
					Let's Talk
				</a>

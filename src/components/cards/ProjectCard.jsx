			...
			<>
				{videoExp !== "" && (
					<a
						...
						className="absolute text-sm md:text-base top-0 right-0 p-2 bg-[#138d32] hover:bg-[#145e26] text-white font-medium rounded-bl-3xl rounded-tr-3xl cursor-pointer transition duration-300 ease-in-out"
					>
						Video Explanation
					</a>
				)}

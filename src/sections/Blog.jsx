...
const Blog = () => {
    const blogData = [
        {
            imgUrl: "https://res.cloudinary.com/dvuazircp/image/upload/v1697418362/new_portfolio/react_ssewqz.webp",
        ...
        {
            imgUrl: "https://res.cloudinary.com/dvuazircp/image/upload/v1697418363/new_portfolio/python_imatnk.webp",
        ...
        {
            imgUrl: "https://res.cloudinary.com/dvuazircp/image/upload/v1697418363/new_portfolio/design_purr2k.webp",
    ...
    return (
        ...
        >
            <div className="pt-16 flex flex-col justify-center items-center font-medium">
                <TypingText
                    title="| Blog"
                    textStyles="text-4xl mb-8 font-semibold"
                />

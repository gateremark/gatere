...
const Achievements = () => {
	const achievementData = [
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697061515/new_portfolio/mlsa_ruvsls.webp",
		...
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697061470/new_portfolio/emai_lfxjtq.webp",
		...
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1702278864/new_portfolio/globalai_cz5o7m.svg",
		...
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1702495519/new_portfolio/msreactor_xu9ye8.svg",
			title: "Featured - Microsoft Reactor",
			link: "https://developer.microsoft.com/en-us/reactor/events/21444/",
		},
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1703161663/new_portfolio/gdg_efz2ec.webp",
			title: "Google Developer Groups, Organizer",
			link: "https://gdg.community.dev/gdg-nyeri/",
		},
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1703093623/new_portfolio/gdl-ml_ncui8y.webp",
			title: "Technical Blogger, Google Dev Library",
			link: "https://devlibrary.withgoogle.com/authors/gateremark",
		},
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697061541/new_portfolio/ysk_fwqpaf.webp",
		...
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697061565/new_portfolio/zindi_klkyw3.webp",
		...
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697061683/new_portfolio/huggingface_fgpznv.webp",
			title: "Hugging Face Ambassador",
			link: "https://www.linkedin.com/posts/gateremark_machinelearning-huggingface-artificialintelligence-activity-6944601724997238784-RezJ?utm_source=share&utm_medium=member_desktop",
		},
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1698216904/new_portfolio/azure_lmxkhu.webp",
			title: "Microsoft Certified: Azure AI Fundamentals",
			link: "https://learn.microsoft.com/en-us/users/gateremark/credentials/F865042F07E63125",
		},
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697066232/new_portfolio/dsaic_flfyo4.webp",
			title: "Data Science and Artificial Intelligence Club, Vice President",
			link: "https://twitter.com/dsaic_dekut",
		},
		{
			imgUrl:
				"https://res.cloudinary.com/dvuazircp/image/upload/v1697061969/new_portfolio/csok_ue6tpp.webp",

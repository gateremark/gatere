		...
		<section id="About" className="ms-auto me-auto md:w-full">
			<div className=" pt-28 flex flex-col justify-center items-center font-medium">
				<div className="md:flex justify-between w-[90%] md:w-[90%] lg:w-[75%]">
					<div className="w-48 hidden md:w-72 aspect-square rounded-[2rem] bg-gradient-to-tr from-[#690cc600] via-[#430680] to-[#690cc600] hover:bg-[#430680] transition ease-in-out duration-[400ms] md:flex items-center justify-center">
						<img
					...
					<div className=" flex flex-col justify-between items-center md:items-start">
						...
						<div className="md:hidden w-48 mt-5 md:my-5 md:w-72 aspect-square rounded-[2rem] bg-gradient-to-tr from-[#690cc600] via-[#430680] to-[#690cc600] hover:bg-[#430680] transition ease-in-out duration-[400ms] flex items-center justify-center">
							<img
								className="w-48 md:w-72 rounded-[2rem] overflow-hidden rotate-[10deg] hover:rotate-0 transition ease-in-out duration-500"
								src="/gmark.jpg"
								alt="Mark Gatere"
						...
						<div className=" my-6 grid grid-cols-2 gap-5 justify-between items-center">
							{data.map((item) => (
						...
						<a
							...
							href="#Contact"
						>
							Download Resume <LuExternalLink />
						</a>
					</div>
				</div>
			</div>
